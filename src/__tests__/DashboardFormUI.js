...
const bill = {
  ...
  "fileUrl": "https://firebasestorage.googleapis.com/v0/b/billable-677b6.appspot.com/o/justificatifs%2Fallo18.jpg?alt=media&token=46b6ab48-8b1c-46d3-8f61-0b410d8bdaf5",
  "status": "accepted",
...
describe('Given I am connected as an Admin and I am on Dashboard Page', () => {
  // Étant donné que je suis connecté en tant qu'administrateur et que je suis sur la page du tableau de bord
  describe('When bill data is passed to DashboardUI', () => {
    // Lorsque les données de facturation sont transmises à DashboardUI
    test(('Then, it should them in the page'), () => {
      // Ensuite, il devrait les dans la page
  ...
  describe('When pending bill is passed to DashboardUI', () => {
    // Lorsque la facture en attente est transmise à DashboardUI
  ...
  describe('When accepted bill is passed to DashboardUI', () => {
    // Lorsque la facture acceptée est transmise à DashboardUI
  ...
  describe('When acceptrefuseded bill is passed to DashboardUI', () => {
    // Lorsque la facture acceptée et refusée est transmise à DashboardUI
    test(('Then, it should show admin commentary'), () => {
      // Ensuite, il devrait afficher le commentaire de l'administrateur
